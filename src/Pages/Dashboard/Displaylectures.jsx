               ...
               (<div className="flex justify-center gap-10 w-full">
                ...
                <ul className="w-[28rem] p-2 rounded-lg shadow-[0_0_10px_black] space-y-4">
                    <li className="font-semibold text-xl text-yellow-500 flex items-center justify-between">
                        <p>Lectures list</p>
                        {role === "ADMIN" && (
                            <button onClick={() => navigate("/course/addlecture", {state: {...state}})} className="btn btn-info px-2 py-1 rounded-md font-semibold text-sm">
                                Add new lecture
                            </button>
                        )}
                    </li>
                        ...
                        lectures.map((lecture, idx) => {
                            return (
                                <li className="space-y-2" key={lecture._id}>
                                    ...
                                    {role === "ADMIN" && (
                                        <button onClick={() => onLectureDelete(state?._id, lecture?._id)} className="btn btn-outline btn-error px-2 py-1 rounded-md font-semibold text-sm">
                                           Delete lecture
                                        </button>
                        )}
                                </li>
